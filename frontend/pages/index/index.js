        ...
        try {
            ...
            this.categoryNav.querySelectorAll('.category-item').forEach(el => {
                el.addEventListener('click', () => {
                    this.categoryNav.querySelectorAll('.category-item').forEach(i => i.classList.remove('active'));
                    el.classList.add('active');
                    this.currentCategory = el.dataset.id;
                    this.searchCategory.value = this.currentCategory;
                    this.currentPage = 1;
                    this.loadProducts();
                });
            });
