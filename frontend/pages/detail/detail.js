...
async function loadDetail() {
    try {
        ...
        const isFavorite = favCheck.isFavorite;
        ...
        container.innerHTML = `
            ...
            <div class="detail-info">
                ...
                <div class="meta">
                    ...
                    <span style="margin-left:16px;">❤️ ${product.favorite_count || 0}人收藏</span>
                ...
                <div class="contact">
                    <div><span class="label">📞 联系方式</span></div>
                ...
                <div class="detail-actions">
                    ...
                    ${user && !isOwner && product.status === 'on_sale' ? `
                        <button class="btn btn-primary" id="favorite-btn">${isFavorite ? '❤️ 已收藏' : '🤍 收藏'}</button>
                        <a href="tel:${product.contact_phone || ''}" class="btn btn-success" style="text-decoration:none;">📞 联系卖家</a>
                    ` : ''}
            ...
            favBtn.addEventListener('click', async () => {
                try {
                    if (isFavorite) {
                        ...
                        document.querySelector('.meta span:last-child').textContent = `❤️ ${(product.favorite_count || 0)}人收藏`;
                    } else {
                        ...
                        countSpan.textContent = `❤️ ${count}人收藏`;
                    }
                } catch (err) {
                    alert(err.message);
                }
